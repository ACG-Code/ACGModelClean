...
class Ui_create_window(object):
    def setupUi(self, create_window):
        ...
        self.btnbox = QtWidgets.QDialogButtonBox(create_window)
        self.btnbox.setGeometry(QtCore.QRect(30, 500, 631, 32))
        ...
        self.gridLayout.addWidget(self.btn_save, 10, 3, 1, 2)
        ...
        self.gridLayout.addItem(spacerItem10, 10, 5, 1, 1)
